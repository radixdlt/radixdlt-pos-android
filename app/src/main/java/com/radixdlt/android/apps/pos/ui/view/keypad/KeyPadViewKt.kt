package com.radixdlt.android.apps.pos.ui.view.keypad
...
class KeyPadView : FrameLayout, View.OnClickListener, View.OnLongClickListener {
    ...
    var textGetListener: TextGetListener? = null
        private set
    ...
    fun setOnTextChangeListener(textGetListener: TextGetListener) {
    ...
    override fun onClick(view: View) {
        ...
        textGetListener?.let {
            it(digits, textLengthLimit - digits.length)
        }
    }
